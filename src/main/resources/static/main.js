...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../user.service */ "./src/user.service.ts");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 2, vars: 3, consts: [["class", "user", 4, "ngFor", "ngForOf"], [1, "user"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
class UserService {
    constructor(http) {
        this.http = http;
        this.url = _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].API_URL + '/users';
    }
    findAll() {
...
module.exports = __webpack_require__(/*! /home/drikc/Dropbox/workspaces/linux/angular-dockerized/src/main.ts */"./src/main.ts");
